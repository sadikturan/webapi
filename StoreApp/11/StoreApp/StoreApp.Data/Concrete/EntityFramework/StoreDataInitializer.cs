    ...
    public class StoreDataInitializer : DropCreateDatabaseAlways<StoreContext>
    {
        protected override void Seed(StoreContext context)
        {
            ...
            new List<Product>
            {
                ...
                new Product() { Name="IPhone 5", Description="idare eder", Price=800, CategoryId=1,isApproved=true},
                new Product() { Name="IPhone 6", Description="idare eder", Price=800, CategoryId=1},
                new Product() { Name="IPhone 7", Description="güzel", Price=3500, CategoryId=2,isApproved=true},
